  ...
  <div class="row g-0">
    ...
    <div className="col-md-8">
      <div className="card-body">
        ...
        <button type="button" className="btn btn-success">{diamond.action}</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div className="row g-0">
    ...
    <div className="col-md-8">
      <div className="card-body">
        ...
        <button type="button" className="btn btn-success">{silver.action}</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div className="row g-0">
    ...
    <div className="col-md-8">
      <div className="card-body">
        ...
        <button type="button" className="btn btn-success">{gold.action}</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div className="row g-0">
    ...
    <div className="col-md-8">
      <div className="card-body">
        ...
        <button type="button" className="btn btn-success">{bronze.action}</button>
      </div>
    </div>
  </div>
</div>
