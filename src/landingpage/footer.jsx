...
const Footer = () => {
  ...
  <div className="container text-center" style={{width:'50rem'}}> 
    <div className=" p-4"  style={{backgroundColor:'#00B549',borderRadius:'10px'}}>
        <div className=" d-flex" style={{marginLeft:'80px'}}>
               
               <h4 className='text-white pt-1 '>Signup for our Blog:</h4>
               
        
            <div className="input-group ms-1" style={{width:'20rem'}}>
    ...
    <div className="footer-top" style={{backgroundColor:'#5920C5'}}>
      <div className="container " >
        <div className="row pt-5">
          ...
          <div className="accordion col-3" id="accordionExample">
