    ...
    <div id='font'>
      <div className='pb-5' style={{backgroundColor: '#5920C5'}}>
        <div className='container p-4 text-center'>
            <h1 className='text-white fw-bold p-5'>PARTNER WITH US</h1>
            <p className='text-white pb-4 fw-semibold'>As our partner strengthen your relationship with your small business partners, and scale your business to the next level of success</p>
            </div>
