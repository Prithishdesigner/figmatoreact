...
const Restaurantcencard = () => {
  ...
  return (
    <div id='font'>
    <div className='container grid text-center d-flex justify-content-between' style={{marginTop:'70px',marginBottom:'100px'}}>
...
export default Restaurantcencard